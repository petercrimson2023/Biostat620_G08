...
model_lag <-  lm(Social.ST.min ~ Social.ST.min_lag1 + Stay.late + Temperature_F * Snow + Duration.per.use + Semester + Weekday*Steps, data = data_merge)
summary(model_lag)
vif(model_lag)
```
```{r}
...
abline(h=0, col="red")
plot(model_lag$residuals, ylab="Residuals")
abline(h=0, col="red")
